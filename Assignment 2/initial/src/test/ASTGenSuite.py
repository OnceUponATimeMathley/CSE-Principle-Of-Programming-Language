...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_case_10(self):
        ...
        EndBody.
        """
        f = Dowhile(([], [Assign(ArrayCell(Id('arr'), [BinaryOp('+', IntLiteral(31), CallExpr(Id('food'), [FloatLiteral(2.0)]))]), BinaryOp('+', ArrayCell(Id('a'), [ArrayCell(Id('f'), [IntLiteral(2), IntLiteral(32)])]), IntLiteral(5)))]), BinaryOp('==', Id('i'), BooleanLiteral(False)))
        fn = FuncDecl(Id('m'), [], ([], [f]))
        expect =  Program([fn])
    ...
    def test_case_16(self):
        ...
        EndBody.
        """
        expect =  Program([FuncDecl(Id('mainMax'), [], ([], [Dowhile(([VarDecl(Id('r'), [], IntLiteral(12))], [Assign(Id('k'), UnaryOp('-.', UnaryOp('-', Id('k')))), \
    ...
    def test_case_19(self):
        ...
        EndBody.
        """
        expect =  Program([FuncDecl(Id('sortArr'), [VarDecl(Id('arr'), [0o100], None), VarDecl(Id('left'), [], None), VarDecl(Id('right'), [], None)], ([], [\
    ...
    def test_case_31(self):
        ...
        EndBody.
        """
        expect = Program([FuncDecl(Id('main'), [],([], [If([(StringLiteral(''),[],[Assign(Id('in'),BinaryOp('||',BinaryOp('+.',BinaryOp('-',IntLiteral(1223),IntLiteral(4234)),IntLiteral(432)),UnaryOp('!',BooleanLiteral(False)))),Assign(Id('inp'),BinaryOp('*',ArrayLiteral([IntLiteral(123),IntLiteral(435),IntLiteral(423)]),Id('in')))])], ([], []))]))])
